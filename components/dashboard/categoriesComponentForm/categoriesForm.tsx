...
export default function CategoriesForm({
	...
	return (
		<div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 !m-0">
			<div className="w-full max-w-xl bg-white rounded-lg shadow-lg overflow-auto dark:bg-[#1d1d28] ">
				...
				<form onSubmit={handleSubmit} className="p-6 space-y-6">
					...
					<div className="flex justify-end">
						<button
							type="button"
							onClick={onClose}
							className="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-[#2A2A3B] hover:bg-gray-50 dark:bg-[#2A2A3B] dark:border-gray-800 dark:text-gray-300 dark:hover:bg-gray-800"
						>
							Cancel
						</button>
						<button
