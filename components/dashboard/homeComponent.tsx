	...
	return (
		<div className="space-y-6">
				...
				<div className="flex space-x-2 max-[436px]:mt-4">
					...
					{currentRole === "admin" && (
						<button
							...
							className="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-800 text-sm font-medium rounded-md shadow-sm text-gray-700 dark:text-gray-300 bg-white dark:bg-[#1d1d28]  hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-150"
						>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				<div className="bg-white dark:bg-[#1d1d28]  rounded-lg shadow dark:shadow-gray-700/30 p-6 flex flex-row items-center">
